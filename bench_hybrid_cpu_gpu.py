# https://github.com/facebookresearch/faiss/blob/v1.8.0/benchs/bench_hybrid_cpu_gpu.py
#
# Pre-requisite: https://github.com/facebookresearch/faiss/blob/main/benchs/README.md#experiments-on-1b-elements-dataset
